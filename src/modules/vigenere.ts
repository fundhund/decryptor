...
export const toVigenereCipher = (str: string = '', key: string = '', options?: VigenereOptions) =>
    vigenere(str, key, 'encode', options)

export const fromVigenereCipher = (str: string = '', key: string = '', options?: VigenereOptions) =>
    vigenere(str, key, 'decode', options)
